    ...
    <Shell className="pb-12">
      ...
      <main className="mx-auto mt-8 max-w-7xl space-y-6">
        ...
        <div className="grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
          <Card className="px-6 py-6 md:px-8">
            <div className="flex items-center gap-2 text-sm font-semibold text-slate-900">
              ...
              ContentOps Profile 映射
            </div>
            <div className="mt-5 space-y-3">
              <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4">
                <div className="text-sm font-semibold text-slate-900">定位陈述</div>
                <div className="mt-1 text-sm leading-6 text-slate-600">{artifact.contentOpsProfile.positioning.positioningStatement}</div>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                <div className="text-sm font-semibold text-slate-900">目标受众</div>
                <div className="mt-1 text-sm leading-6 text-slate-600">{artifact.contentOpsProfile.audience.primaryAudience}</div>
                <div className="mt-3 space-y-2">
                  {artifact.contentOpsProfile.audience.audienceNeeds.map((item) => (
                    <div key={item} className="text-sm leading-6 text-slate-500">{item}</div>
                  ))}
                </div>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                <div className="text-sm font-semibold text-slate-900">核心话题与内容支柱</div>
                <div className="mt-3 flex flex-wrap gap-2">
                  {artifact.contentOpsProfile.topics.coreTopics.map((item) => (
                    <Pill key={`topic-${item}`} active>{item}</Pill>
                  ))}
                  {artifact.contentOpsProfile.topics.contentPillars.map((item) => (
                    <Pill key={`pillar-${item}`}>{item}</Pill>
                  ))}
                </div>
              </div>
            </div>
          ...
          <Card className="px-6 py-6 md:px-8">
            ...
            <div className="mt-5 space-y-3">
              {artifact.contentOpsProfile.mappingNotes.map((item) => (
        ...
        <div className="grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
          <Card className="px-6 py-6 md:px-8">
            <div className="flex items-center gap-2 text-sm font-semibold text-slate-900">
              ...
              Content Boundaries 注入
            </div>
            <div className="mt-5 space-y-3">
              <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4">
                <div className="text-sm font-semibold text-slate-900">Hard Stops</div>
                <div className="mt-3 space-y-2">
                  {artifact.contentBoundaryProfile.boundaries.hardStops.map((item) => (
                    <div key={item} className="text-sm leading-6 text-slate-600">{item}</div>
                  ))}
                </div>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                <div className="text-sm font-semibold text-slate-900">Review Required</div>
                <div className="mt-3 space-y-2">
                  {artifact.contentBoundaryProfile.boundaries.reviewRequired.map((item) => (
                    <div key={item} className="text-sm leading-6 text-slate-600">{item}</div>
                  ))}
                </div>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                <div className="text-sm font-semibold text-slate-900">Injection Targets</div>
                <div className="mt-3 space-y-2">
                  {artifact.contentBoundaryProfile.injectionTargets.map((item) => (
                    <div key={item.target} className="text-sm leading-6 text-slate-600">
          ...
          <Card className="px-6 py-6 md:px-8">
            ...
            <div className="mt-5 space-y-3">
              {artifact.contentBoundaryProfile.mappingNotes.map((item) => (
                <div key={item.targetField} className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                  <div className="text-sm font-semibold text-slate-900">{item.targetField}</div>
                  <div className="mt-1 text-sm leading-6 text-slate-500">
                    来源：
        ...
        <div className="grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
          <Card className="px-6 py-6 md:px-8">
            <div className="flex items-center gap-2 text-sm font-semibold text-slate-900">
              <BookOpenText className="h-4 w-4 text-fuchsia-600" />
              Style Card
            </div>
            <div className="mt-5 space-y-3">
              <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4">
                <div className="text-sm font-semibold text-slate-900">Voice</div>
                <div className="mt-3 space-y-2">
                  {artifact.styleCard.voice.tone.map((item) => (
                    <div key={item} className="text-sm leading-6 text-slate-600">{item}</div>
                  ))}
                </div>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                <div className="text-sm font-semibold text-slate-900">Preferred Moves</div>
                <div className="mt-3 space-y-2">
                  {artifact.styleCard.expression.preferredMoves.map((item) => (
                    <div key={item} className="text-sm leading-6 text-slate-600">{item}</div>
                  ))}
                </div>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                <div className="text-sm font-semibold text-slate-900">ContentOps Use</div>
                <div className="mt-3 space-y-2">
                  {artifact.styleCard.contentOpsUse.draftingHints.map((item) => (
                    <div key={item} className="text-sm leading-6 text-slate-600">{item}</div>
                  ))}
                </div>
              </div>
          ...
          <Card className="px-6 py-6 md:px-8">
            <div className="flex items-center gap-2 text-sm font-semibold text-slate-900">
              <FolderTree className="h-4 w-4 text-fuchsia-600" />
              Style 字段说明
            </div>
            <div className="mt-5 space-y-3">
              {artifact.styleCard.mappingNotes.map((item) => (
                <div key={item.targetField} className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                  <div className="text-sm font-semibold text-slate-900">{item.targetField}</div>
                  <div className="mt-1 text-sm leading-6 text-slate-500">
                    来源：
        ...
        <div className="grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
          <Card className="px-6 py-6 md:px-8">
            ...
            <div className="mt-5 space-y-3">
              {artifact.sourceMap.categories.map((item) => (
                <div key={item.name} className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                  <div className="flex items-center justify-between gap-3">
                    <div className="text-sm font-semibold text-slate-900">{item.name}</div>
                    <Pill active={item.readiness === "ready"}>
                      {item.readiness === "ready" ? "ready" : item.readiness === "optional" ? "optional" : "later"}
                    </Pill>
                  </div>
                  <div className="mt-2 text-sm leading-6 text-slate-600">{item.summary}</div>
                  <div className="mt-3 space-y-1">
                    {item.examples.map((example) => (
                      <div key={example} className="text-sm leading-6 text-slate-500">{example}</div>
                    ))}
                  </div>
                </div>
              ))}
          ...
          <Card className="px-6 py-6 md:px-8">
            ...
            <div className="mt-5 space-y-3">
              <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4">
                <div className="text-sm font-semibold text-slate-900">Pre-Draft Sources</div>
                <div className="mt-3 space-y-2">
                  {artifact.sourceMap.contentOpsUse.preDraftSources.map((item) => (
                    <div key={item} className="text-sm leading-6 text-slate-600">{item}</div>
                  ))}
                </div>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                <div className="text-sm font-semibold text-slate-900">Fallback Plan</div>
                <div className="mt-3 space-y-2">
                  {artifact.sourceMap.contentOpsUse.fallbackPlan.map((item) => (
                    <div key={item} className="text-sm leading-6 text-slate-600">{item}</div>
                  ))}
                </div>
              </div>
              {artifact.sourceMap.mappingNotes.map((item) => (
                <div key={item.targetField} className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                  <div className="text-sm font-semibold text-slate-900">{item.targetField}</div>
                  <div className="mt-1 text-sm leading-6 text-slate-500">
                    来源：
        ...
        <div className="grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
          <Card className="px-6 py-6 md:px-8">
            ...
            <div className="mt-5 space-y-3">
              <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4">
                <div className="text-sm font-semibold text-slate-900">Draft Inputs</div>
                <div className="mt-2 text-sm leading-6 text-slate-600">{artifact.draftContextBundle.draftInputs.positioning}</div>
                <div className="mt-3 space-y-1">
                  {artifact.draftContextBundle.draftInputs.contentPillars.map((item) => (
                    <div key={item} className="text-sm leading-6 text-slate-500">{item}</div>
                  ))}
                </div>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                <div className="text-sm font-semibold text-slate-900">Draft Flow</div>
                <div className="mt-3 space-y-2">
                  {artifact.draftContextBundle.draftFlow.map((item) => (
                    <div key={item} className="text-sm leading-6 text-slate-600">{item}</div>
                  ))}
                </div>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                <div className="text-sm font-semibold text-slate-900">Review Checklist</div>
                <div className="mt-3 space-y-2">
                  {artifact.draftContextBundle.reviewChecklist.map((item) => (
                    <div key={item} className="text-sm leading-6 text-slate-600">{item}</div>
                  ))}
                </div>
              </div>
          ...
          <Card className="px-6 py-6 md:px-8">
            ...
            <div className="mt-5 space-y-3">
              {artifact.draftContextBundle.mappingNotes.map((item) => (
                <div key={item.targetField} className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                  <div className="text-sm font-semibold text-slate-900">{item.targetField}</div>
                  <div className="mt-1 text-sm leading-6 text-slate-500">
                    来源：
        ...
        <div className="grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
          <Card className="px-6 py-6 md:px-8">
            ...
            <div className="mt-5 space-y-3">
              <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4">
                <div className="text-sm font-semibold text-slate-900">System Intent</div>
                <div className="mt-2 text-sm leading-6 text-slate-600">{artifact.draftPromptPack.systemIntent}</div>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                <div className="text-sm font-semibold text-slate-900">Usage Notes</div>
                <div className="mt-3 space-y-2">
                  {artifact.draftPromptPack.usageNotes.map((item) => (
                    <div key={item} className="text-sm leading-6 text-slate-600">{item}</div>
                  ))}
                </div>
              </div>
          ...
          <Card className="px-6 py-6 md:px-8">
            ...
            <div className="mt-5 space-y-3">
              {artifact.draftPromptPack.mappingNotes.map((item) => (
                <div key={item.targetField} className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                  <div className="text-sm font-semibold text-slate-900">{item.targetField}</div>
                  <div className="mt-1 text-sm leading-6 text-slate-500">
                    来源：
